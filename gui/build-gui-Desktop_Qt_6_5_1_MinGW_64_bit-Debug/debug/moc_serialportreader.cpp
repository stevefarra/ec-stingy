...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSerialPortReaderENDCLASS_t qt_meta_stringdata_CLASSSerialPortReaderENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(17, 7),  // "newData"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 4),  // "data"
        QT_MOC_LITERAL(31, 10),  // "newECGData"
        QT_MOC_LITERAL(42, 7),  // "ecgData"
        QT_MOC_LITERAL(50, 16),  // "newHeartRateData"
        QT_MOC_LITERAL(67, 9),  // "heartRate"
        QT_MOC_LITERAL(77, 15),  // "handleReadyRead"
...
void SerialPortReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newData((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->newECGData((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->newHeartRateData((*reinterpret_cast< std::add_pointer_t<uint>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SerialPortReader::newData; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SerialPortReader::*)(int );
            if (_t _q_method = &SerialPortReader::newECGData; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SerialPortReader::*)(unsigned int );
            if (_t _q_method = &SerialPortReader::newHeartRateData; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SerialPortReader::newData(const QByteArray & _t1)
{
...
// SIGNAL 1
void SerialPortReader::newECGData(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void SerialPortReader::newHeartRateData(unsigned int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
